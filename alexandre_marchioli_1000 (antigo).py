...
dataexemplos = pd.read_csv('C:/Users/User/3D Objects/PYTHON/UEL/Aula 18 - dataexemplos.csv')
dataset = pd.read_csv('C:/Users/User/3D Objects/PYTHON/UEL/Aula 18 - dataset.csv')
